...
/**
 * 在此处添加了配置使得能够监控数据库，在YML文件中配置不能查看日志   
 * http://localhost/firstboot/druid/sql.html
 * @author BestSteven
 * 
 */
@Configuration
// 注解@PropertySource 用于指定配置文件名称，默认的配置文件为application.yml 或者 application.properties
